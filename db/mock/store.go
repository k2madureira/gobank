...
// Source: github.com/k2madureira/gobank/db/sqlc (interfaces: Store)
...
func (m *MockStore) AddAccountBalance(arg0 context.Context, arg1 dbbank.AddAccountBalanceParams) (dbbank.Account, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AddAccountBalance", arg0, arg1)
	ret0, _ := ret[0].(dbbank.Account)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockStore) CreateAccount(arg0 context.Context, arg1 dbbank.CreateAccountParams) (dbbank.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) CreateEntry(arg0 context.Context, arg1 dbbank.CreateEntryParams) (dbbank.Entry, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateEntry", arg0, arg1)
	ret0, _ := ret[0].(dbbank.Entry)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockStore) CreateTransfer(arg0 context.Context, arg1 dbbank.CreateTransferParams) (dbbank.Transfer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateTransfer", arg0, arg1)
	ret0, _ := ret[0].(dbbank.Transfer)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockStore) GetAccount(arg0 context.Context, arg1 int64) (dbbank.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetAccountForUpdate(arg0 context.Context, arg1 int64) (dbbank.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetEntry(arg0 context.Context, arg1 int64) (dbbank.Entry, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetTransfer(arg0 context.Context, arg1 int64) (dbbank.Transfer, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) ListAccounts(arg0 context.Context, arg1 dbbank.ListAccountsParams) ([]dbbank.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) ListEntries(arg0 context.Context, arg1 dbbank.ListEntriesParams) ([]dbbank.Entry, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) ListTransfers(arg0 context.Context, arg1 dbbank.ListTransfersParams) ([]dbbank.Transfer, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) TransferTx(arg0 context.Context, arg1 dbbank.TransferTxParams) (dbbank.TransferTxResult, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TransferTx", arg0, arg1)
	ret0, _ := ret[0].(dbbank.TransferTxResult)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockStore) UpdateAccount(arg0 context.Context, arg1 dbbank.UpdateAccountParams) (dbbank.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) UpdateEntry(arg0 context.Context, arg1 dbbank.UpdateEntryParams) error {
	m.ctrl.T.Helper()
